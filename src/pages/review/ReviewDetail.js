...
const ReviewDetail = () => {
  ...
  const loadData = async () => {
    try {
      const res = await axios.post(`https://port-0-eatmate-backend-mlem81pp426165a9.sel3.cloudtype.app/review/detail/${br_no}`);
  ...
  const boardDelete = async (br_no) => {
    if (window.confirm('해당 게시글을 삭제하시겠습니까?')) {
      try {
        await axios.delete(`https://port-0-eatmate-backend-mlem81pp426165a9.sel3.cloudtype.app/review/detail/${br_no}`);
        ...
        <div className="review-con" key={reviewData.br_no}>
          <div className="profile-area">
            <div className="img-box">
              <img src={`https://port-0-eatmate-backend-mlem81pp426165a9.sel3.cloudtype.app/uploads/user/${reviewData.u_pic}`} alt={`${reviewData.u_nick} 프로필`} />
            </div>
          ...
          <div className="image-area">
            {
              reviewData.br_img &&
              <div className="img-box">
                <img src={`https://port-0-eatmate-backend-mlem81pp426165a9.sel3.cloudtype.app/uploads/review/${reviewData.br_img}`} alt={`${reviewData.rt_name} 대표`} />
              </div>
            }
            {
              reviewData.br_img2 &&
              <div className="img-box">
                <img src={`https://port-0-eatmate-backend-mlem81pp426165a9.sel3.cloudtype.app/uploads/review/${reviewData.br_img2}`} alt={`${reviewData.rt_name} 서브`} />
              </div>
            }
            {
              reviewData.br_img3 &&
              <div className="img-box">
                <img src={`https://port-0-eatmate-backend-mlem81pp426165a9.sel3.cloudtype.app/uploads/review/${reviewData.br_img3}`} alt={`${reviewData.rt_name} 서브`} />
              </div>
            }
            {
              reviewData.br_img4 &&
              <div className="img-box">
                <img src={`https://port-0-eatmate-backend-mlem81pp426165a9.sel3.cloudtype.app/uploads/review/${reviewData.br_img4}`} alt={`${reviewData.rt_name} 서브`} />
              </div>
            }
            {
              reviewData.br_img5 &&
              <div className="img-box">
                <img src={`https://port-0-eatmate-backend-mlem81pp426165a9.sel3.cloudtype.app/uploads/review/${reviewData.br_img5}`} alt={`${reviewData.rt_name} 서브`} />
              </div>
            }
          </div>
